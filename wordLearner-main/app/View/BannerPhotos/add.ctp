...
<?php
	echo $this->Form->create('BannerPhoto', array('type' => 'file'));
	$id = ($this->request->params['named']['id']); // Pegando do GET
	$nome = ($this->request->params['named']['nome_banner']); //Pegando do GET
	echo $this->Form->input('banner_id', array('type'=>'number', 'value'=>$id, 'hidden', 'label'=>false));
?>
...
<div class="block-flat">
  <form role="form"> 
	<div class="form-group" style="font-size: 20px;">
		<label>Banner: </label><span style="text-transform: uppercase;"> <?= $nome; ?></span>
	</div>
	<div class="form-group">
		<?php echo $this->Form->file('nome_img_banner', array('legend'=>false, 'escape'=>false, 'required')); ?>	
	</div>
<?php	
	...
	echo $this->Html->link
		($this->Html->tag('', 'Cancelar'),
			array('controller'=>'banners', 'action'=>'edit', $id),
