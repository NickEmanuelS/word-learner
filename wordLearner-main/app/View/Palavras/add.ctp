...
<?php
	...
	$dia_id = $this->params['pass'][0];
	
	require_once('../class/db.class.php');
	$DB = new DB();
	$dia = $DB->getDia($dia_id);
	$dia = date_create($dia[0]['dia']);
?>
<div class="col-sm-12 col-md-12"><br><br>
<div class="block-flat" style="width: 50%">
<strong style="font-size: 26px;">New word</strong><br>
<strong style="font-size: 11px;">Day: <?php echo date_format($dia,"d/m/Y"); ?></strong>
  <form role="form"> 
	<div class="form-group">
		<?php echo $this->Form->input('dia_id', array('label'=>false, 'type'=>'hidden', 'value'=>$dia_id)); ?>
		<?php echo $this->Form->input('dsc_palavra', array('label'=>false, 'type'=>'text', 'autofocus', 'required', 'class'=>'form-control', 'placeholder'=>'Type the english word'));?>
	...
	<div class="form-group">
		<?php echo $this->Form->input('traducao_palavra', array('label'=>false,  'type'=>'text', 'required', 'class'=>'form-control', 'placeholder'=>'Digite a palavra em português')); ?>
	...
	<div class="form-group">
		<?php echo $this->Form->input('nota_observacao', array('label'=>false,  'type'=>'textarea', 'class'=>'form-control', 'placeholder'=>'Some observation', 'maxlength'=>'500')); ?>
	</div>
	<div class="checkbox">
		...
		<?php 
				echo $this->Html->link
					($this->Html->tag('', 'Back to my taking note'),
						array('controller'=>'dias', 'action'=>'view', $dia_id),
